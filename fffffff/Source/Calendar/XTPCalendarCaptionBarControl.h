...
public:
	...
	//     TRUE if corresponding object is visible, FALSE otherwise.
	//-----------------------------------------------------------------------
	virtual BOOL IsScrollDateButtons();
	...
	//     bVisible - A BOOL value to define visible state.
	//-----------------------------------------------------------------------
	virtual void SetScrollDateButtons(BOOL bVisible);
	...
	//     bVisible - A BOOL value to define visible state.
	//-----------------------------------------------------------------------
	virtual void SetDateLabel(BOOL bVisible);
	...
	//     bVisible - A BOOL value to define visible state.
	//-----------------------------------------------------------------------
	virtual void SetExpandButton(BOOL bVisible);
...
/////////////////////////////////////////////////////////////////////////////
AFX_INLINE CRect CXTPCalendarCaptionBarControl::GetBorders()
{
	return m_Borders;
}
...
AFX_INLINE BOOL CXTPCalendarCaptionBarTheme::IsExpandButton()
{
