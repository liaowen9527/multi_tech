...
public:
	...
	DECLARE_THEMEPART(CTOPrevNextEventButton, CXTPCalendarThemePart)
		...
		virtual int HitTest(const CPoint* pPoint = NULL); // return 0, xtpCalendarHitTestPrevEventButton or xtpCalendarHitTestNextEventButton
	...
	protected:
		DECLARE_XTP_SINK(CTOPrevNextEventButtons, m_Sink)
...
protected:
	...
	DECLARE_XTP_SINK(CXTPCalendarThemeOffice2007, m_Sink)
