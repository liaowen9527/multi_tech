...
void CXTPSplitterWndThemeResource::RefreshMetrics(CXTPSplitterWnd* pSplitter)
{
	...
	COLORREF clrFace = pImages->GetImageColor(_T("Window"), _T("ButtonFace"));
	clrFace = pImages->GetImageColor(_T("Window"), _T("SplitterBackground"), clrFace);

	m_clrSplitterFace.SetStandardValue(clrFace);
