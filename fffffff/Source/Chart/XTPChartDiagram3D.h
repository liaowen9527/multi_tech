...
AFX_INLINE void CXTPChartDiagram3D::SetShowHandCursor(BOOL bShowHandCursor) {
	m_bShowHandCursor = bShowHandCursor;
	OnChartChanged();
}
AFX_INLINE BOOL CXTPChartDiagram3D::IsShowHandCursor() const {
	return m_bShowHandCursor;
}
