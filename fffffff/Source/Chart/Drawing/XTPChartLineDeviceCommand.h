...
public:
	...
	//-----------------------------------------------------------------------
	CXTPChartDashedLineDeviceCommand(const CXTPChartDiagramPoint& p1, const CXTPChartDiagramPoint& p2, const CXTPChartColor& color, int thickness, XTPChartDashStyle nDashStyle, const CXTPChartLineDashArray& dashArray);
