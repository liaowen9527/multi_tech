...
void CMDITextEditorView::OnReloadSyntaxMode()
{
...
void CMDITextEditorView::OnReloadSyntax2IniMode()
{
...
void CMDITextEditorView::OnUpdateToolsOptions(CCmdUI* pCmdUI)
{
...
void CMDITextEditorView::OnReadOnly()
{
	GetEditCtrl().SetReadOnly(!GetEditCtrl().IsReadOnly());
}

void CMDITextEditorView::OnUpdateReadOnly(CCmdUI* pCmdUI)
{
	pCmdUI->SetCheck(GetEditCtrl().IsReadOnly() ? 1 : 0);
}

void CMDITextEditorView::OnInitialUpdate()
{
