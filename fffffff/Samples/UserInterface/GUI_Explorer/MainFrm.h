...
protected:  // control bar embedded members
	...
	CXTPShellTree*    m_pTreeCtrl;
	CXTPShellList*    m_pListCtrl;
...
protected:
	...
	afx_msg void OnViewSetfilter();

	DECLARE_MESSAGE_MAP()

	friend class CGUI_ExplorerTree;
...
//---------------------------------------------------------------------------
// CAeroSplitterWndThemespecial - consideration for Windows Vista Aero theme.
//---------------------------------------------------------------------------
class CAeroSplitterWndTheme : public CXTPSplitterWndTheme
{
public:
